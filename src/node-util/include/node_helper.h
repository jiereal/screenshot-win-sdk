#ifndef NODE_SDK_HELPER_H
#define NODE_SDK_HELPER_H
...
#define ASSEMBLE_BASE_CALLBACK_EX(index)                          \
	...
	public:
		...
		static utf8_char* calloc_(size_t len)
		{
			return (utf8_char*)calloc(len, 1);
		}
		static void free_(utf8_char* buf)
		{
			free(buf);
		}
