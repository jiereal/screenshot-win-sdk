...
void ListBox::SelectNextWhenActiveRemoved(bool value)
{
	m_bSelNextWhenRemoveActive = value;
}
...
void ListContainerElement::Selected(bool bSelected, bool trigger)
{
	...
	if (!bSelected) __super::Selected(bSelected, trigger);
}

void ListContainerElement::SetAttribute(const std::wstring& strName, const std::wstring& strValue)
{
	if (strName == _T("rightButtonSelect"))
	{
		SetRightButtonSelect(strValue == _T("true"));
	}
	else
	{
...
bool ListContainerElement::IsRightButtonSelect(void) const
{
	return m_bIsRightButtonSelect;
}

void ListContainerElement::SetRightButtonSelect(bool bRightButtonSelect)
{
	m_bIsRightButtonSelect = bRightButtonSelect;
}
