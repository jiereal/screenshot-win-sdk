...
public:
	...
	void PaintExpandImage(IRenderContext* pRender);

	std::wstring GetExpandImage(void) const;
	void SetExpandImage(const std::wstring& strImage);
	std::wstring GetCollapseImage(void) const;
	void SetCollapseImage(const std::wstring& strImage);
